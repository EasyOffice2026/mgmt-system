            ...
            <div id="expense-print-form" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
              <div className="flex items-center gap-4 border-b pb-4 mb-4">
                ...
                <div className={lang === 'ar' ? 'text-right flex-1' : 'text-left flex-1'}>
                  ...
                  <h2 className="text-lg text-slate-600 font-semibold mt-1">{t('expenseVoucherForm')}</h2>
                </div>
              </div>

                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <Badge className={ct.status === 'ongoing' ? 'bg-blue-100 text-blue-700' : ct.status === 'finished' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'} variant="secondary">
                            {t(ct.status as any)}
                          </Badge>
                        </div>
          ...
          <CardContent className="p-4 space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3 text-sm">
              ...
              <div className="bg-slate-50 rounded-lg p-3">
                ...
                <Badge className={selectedContract.status === 'ongoing' ? 'bg-blue-100 text-blue-700' : selectedContract.status === 'finished' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'} variant="secondary">

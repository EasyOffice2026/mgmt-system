export const ar = {
  ...
  paymentModeReport: 'تقرير طرق الدفع',
  balance: 'الرصيد',
  checks: 'شيكات',
  cash: 'نقداً',
  ...
  originalAmount: 'أصل الدين',
  actualAmount: 'المبلغ الفعلي',
  claimedAmount: 'المبلغ المطالب به',
  remainingFromCustomer: 'المتبقي',
  caseAmount: 'مبلغ التنفيذ',
  ...
  incomeRecovery: 'الدخل والتحصيل',
  salesIncomeAccrual: 'إيرادات المبيعات (استحقاق)',
  contractSalesValue: 'قيمة مبيعات العقود',
  totalBilledIncome: 'إجمالي الدخل المستحق',
  cashCollected: 'النقد المحصّل',
  installmentReceipts: 'إيصالات الأقساط',
  courtMoneyReceipts: 'إيصالات أموال المحكمة',
  otherReceipts: 'إيصالات أخرى',
  netCashReceived: 'صافي النقد المستلم',
  receivablesBadDebt: 'الذمم المدينة والديون المعدومة',
  dueFromCustomersCollectible: 'المستحق من العملاء (قابل للتحصيل)',
  badDebtInCourt: 'ديون معدومة في المحكمة (مبلغ التنفيذ)',
  recoveredFromCourt: 'المحصّل من المحكمة',
  netBadDebtOutstanding: 'صافي الديون المعدومة القائمة',
  collectionRate: 'نسبة التحصيل',
  collectionRateDesc: 'صافي النقد المستلم ÷ إجمالي الدخل المستحق',

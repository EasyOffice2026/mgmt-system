export const en = {
  ...
  paymentModeReport: 'Payment Mode Report',
  balance: 'Balance',
  checks: 'Checks',
  cash: 'Cash',
  ...
  incomeRecovery: 'Income & Recovery',
  salesIncomeAccrual: 'Sales Income (Accrual)',
  contractSalesValue: 'Contract Sales Value',
  totalBilledIncome: 'Total Billed Income',
  cashCollected: 'Cash Collected',
  installmentReceipts: 'Installment Receipts',
  courtMoneyReceipts: 'Court Money Receipts',
  otherReceipts: 'Other Receipts',
  netCashReceived: 'Net Cash Received',
  receivablesBadDebt: 'Receivables & Bad Debt',
  dueFromCustomersCollectible: 'Due from Customers (collectible)',
  badDebtInCourt: 'Bad Debt in Court (execution amount)',
  recoveredFromCourt: 'Recovered from Court',
  netBadDebtOutstanding: 'Net Bad Debt Outstanding',
  collectionRate: 'Collection Rate',
  collectionRateDesc: 'Net cash received ÷ total billed income',
